...
class ShiftDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final expectedCard = (shift.cardTotal ?? 0.0) +
        (shift.debtCollectionsCard ?? 0.0) -
        (shift.refundsCard ?? 0.0);
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: isMatched
                          ? Colors.green
                          : (hasShortage ? Colors.red : Colors.amber),
                    ),
                  ),
                  child: Text(
                    isMatched
                    ...
                    style: TextStyle(
                      ...
                      color: isMatched
                          ...
                          : (hasShortage ? Colors.red : Colors.amber.shade700),
                    ),
                  ),
                ),
              ],
