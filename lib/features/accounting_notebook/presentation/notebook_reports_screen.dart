              ...
              return txsAsync.when(
                data: (allTransactions) {
                  final transactions = allTransactions
                      .where((t) =>
                          t.bookId == _selectedBookId &&
                          _isWithinPeriod(t.date))
                      .toList();
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          decoration:
                              InputDecoration(labelText: l10n.notebookBook),
                          items: books
                        ...
                        SegmentedButton<String>(
                          segments: [
                            ...
                            ButtonSegment(
                                value: 'today',
                                label: Text(l10n.notebookToday)),
                            ButtonSegment(
                                value: 'week', label: Text(l10n.notebookWeek)),
                            ButtonSegment(
                                value: 'month',
                                label: Text(l10n.notebookMonth)),
                          ],
                          selected: {_period},
                            ...
                            ElevatedButton.icon(
                              ...
                              onPressed: () async {
                                ...
                                await NotebookCsvService.shareCsv(
                                    csvData, 'accounting_report.csv', l10n);
                              },
                            ),
                          ],
                        ),
