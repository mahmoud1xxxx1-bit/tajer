                ...
                child: peopleAsync.when(
                  ...
                  data: (allPeople) {
                    final people = allPeople
                        .where((p) => p.bookId == _selectedBookId)
                        .toList();
                    if (people.isEmpty) {
                              ...
                              if (!isArchived)
                                IconButton(
                                  icon: const Icon(Icons.edit,
                                      color: Colors.blue),
                                  onPressed: () =>
                                      _showEditPersonDialog(context, ref, p),
                                ),
                              if (!isArchived)
                                IconButton(
                                  icon: const Icon(Icons.archive,
                                      color: Colors.red),
                                  onPressed: () =>
                                      _showArchiveDialog(context, ref, p.id),
                                )
                              else
                                IconButton(
                                  icon: const Icon(Icons.restore,
                                      color: Colors.green),
                                  onPressed: () =>
                                      _showRestoreDialog(context, ref, p.id),
                                ),
                              IconButton(
                                icon: Icon(Icons.assignment,
                                    color:
                                        isArchived ? Colors.grey : Colors.teal),
                                onPressed: () => context.push(
                                    '/notebook/people/${p.id}'), // Statement
                              ),
                            ],
                          ),
                        );
