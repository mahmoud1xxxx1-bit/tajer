...
class _SuppliersScreenState extends ConsumerState<SuppliersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.text122, style: const TextStyle(fontFamily: 'Tajawal')),
      ),
      body: Column(
        children: [
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    FilterChip(
                      label: Text(AppLocalizations.of(context)!.hasDebts, style: const TextStyle(fontFamily: 'Tajawal')),
                    ...
                    const Spacer(),
                    Text(AppLocalizations.of(context)!.sortBy, style: const TextStyle(fontFamily: 'Tajawal', fontWeight: FontWeight.bold, fontSize: 12)),
                    DropdownButton<String>(
                      value: _sortOption,
                      underline: const SizedBox(),
                      items: [
                        const DropdownMenuItem(value: 'newest', child: Text('الأحدث', style: TextStyle(fontFamily: 'Tajawal', fontSize: 13))),
                        DropdownMenuItem(value: 'debt', child: Text(AppLocalizations.of(context)!.highestDebt, style: const TextStyle(fontFamily: 'Tajawal', fontSize: 13))),
                        DropdownMenuItem(value: 'alpha', child: Text(AppLocalizations.of(context)!.sortAlphabetical, style: const TextStyle(fontFamily: 'Tajawal', fontSize: 13))),
                      ],
                      onChanged: (val) {
            ...
            child: query == null
                ...
                : FirestoreListView<Supplier>(
                    ...
                    emptyBuilder: (context) => Center(
                      child: Text(AppLocalizations.of(context)!.text123, style: const TextStyle(fontFamily: 'Tajawal')),
                    ),
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      supplier.name,
                                      style: TextStyle(fontWeight: FontWeight.bold, fontFamily: 'Tajawal', fontSize: 17, decoration: !supplier.isActive ? TextDecoration.lineThrough : null, color: !supplier.isActive ? Colors.grey : null),
                                      maxLines: 1,
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(supplier.phone ?? AppLocalizations.of(context)!.text124, style: TextStyle(fontFamily: 'Tajawal', color: Colors.grey[700], fontSize: 13)),
                                      ],
                                    ),
                                  ],
                                ),
                              ...
                              Column(
                                ...
                                children: [
                                  Text(AppLocalizations.of(context)!.text125, style: const TextStyle(fontSize: 11, color: Colors.grey, fontFamily: 'Tajawal')),
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(color: supplier.totalDebt > 0 ? Colors.red : Colors.green, fontWeight: FontWeight.bold, fontSize: 14, fontFamily: 'Tajawal'),
                                    ),
                                  ),
                                ],
                              ),
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                TextField(controller: nameController, decoration: InputDecoration(labelText: AppLocalizations.of(context)!.text127)),
                const SizedBox(height: 12),
                TextField(controller: phoneController, keyboardType: TextInputType.phone, decoration: InputDecoration(labelText: AppLocalizations.of(context)!.text128)),
                const SizedBox(height: 12),
                TextField(controller: debtController, keyboardType: TextInputType.number, decoration: InputDecoration(labelText: AppLocalizations.of(context)!.text129)),
              ],
            ),
          ),
          actions: [
            TextButton(onPressed: () => Navigator.pop(context), child: Text(AppLocalizations.of(context)!.text43)),
            ElevatedButton(
              onPressed: () {
