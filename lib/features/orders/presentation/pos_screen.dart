...
class _PosScreenState extends ConsumerState<PosScreen> {
  ...
  double get _grandTotal {
    ...
    for (var item in _cart) {
      ...
      final itemInclusive = item.taxMode == TaxMode.custom
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await ActivityLogger.log(
                ...
                description:
                    'Added customer (${newCustomer.name}) from POS|تم إضافة العميل (${newCustomer.name}) من الكاشير',
              );
                        ...
                        onChanged: (val) {
                          ...
                          if (cash <= requiredAmount) {
                            _splitNetworkController.text =
                                (requiredAmount - cash).toStringAsFixed(2);
                          }
                          setState(() {});
                        },
                      ),
                        ...
                        onChanged: (val) {
                          ...
                          if (network <= requiredAmount) {
                            _splitCashController.text =
                                (requiredAmount - network).toStringAsFixed(2);
                          }
                          setState(() {});
                        },
                      ),
