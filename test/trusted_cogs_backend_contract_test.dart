...
void main() {
  group('Trusted COGS backend contract', () {
    ...
    test('incomplete authoritative cost fails closed instead of reporting partial profit', () {
      expect(functionSource, contains('isComplete: complete'));
      expect(functionSource, contains('totalCost: complete ? calculatedTotalCost : null'));
    });
