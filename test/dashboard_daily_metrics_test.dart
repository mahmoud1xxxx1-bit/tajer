...
void main() {
  test('dashboard counts only the local calendar day', () {
    ...
    final metrics = DashboardDailyMetrics.fromOrders(
      [
        order(id: 'yesterday', total: 900, createdAt: DateTime(2026, 8, 11, 23, 59, 59)),
        order(id: 'start', total: 60, createdAt: DateTime(2026, 8, 12, 0, 0)),
        order(id: 'today', total: 40, createdAt: DateTime(2026, 8, 12, 23, 59, 59)),
  ...
  test('dashboard excludes cancelled and debt repayment records', () {
    ...
    final metrics = DashboardDailyMetrics.fromOrders(
      [
        ...
        order(id: 'cancelled', total: 200, createdAt: DateTime(2026, 8, 12, 10), status: 'cancelled'),
        order(id: 'debt', total: 300, createdAt: DateTime(2026, 8, 12, 11), status: 'debt_repayment'),
      ],
      now: now,
    );
